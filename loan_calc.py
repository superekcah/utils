...
BASE_INTEREST_RATES = [
    ...
    (datetime(2015, 3, 1), 5.90),
    (datetime(2015, 5, 11), 5.65),
    (datetime(2015, 6, 28), 5.40),
    (datetime(2015, 8, 26), 5.15),
    (datetime(2015, 10, 24), 4.90)
]
...
def main():
    calc_payment_list(2010, 2, 360, 1390000, 80)
